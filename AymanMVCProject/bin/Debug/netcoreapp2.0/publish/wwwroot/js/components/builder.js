var builder = (function () {
    ...
    var indicator = function (indicator) {
        ...
        if(indicator === utils.indicators.positive) {
            //span = $('<span>').addClass('label label-success').html("Positive");
            span = $('<span />',{
            ...
            //span = $('<span>').addClass('label label-default').html("Neutral");
            span = $('<span />',{
            ...
            //span = $('<span>').addClass('label label-danger').html("Negative");
            span = $('<span />',{
